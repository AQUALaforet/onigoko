...
execute if score mode settings matches 0..4 if score firework settings matches 0 if score sec time matches 0 if score sec2 time matches 0 if score min time matches 4..5 as @a[team=nge] at @s run summon firework_rocket ~ ~ ~ {Life:40,LifeTime:60,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball",has_twinkle:true,has_trail:true,colors:[65527]}]}}}}
execute if score mode settings matches 0..4 if score firework settings matches 0 if score sec time matches 0 if score sec2 time matches 0 if score min time matches 1..3 as @a[team=nge] at @s run summon firework_rocket ~ ~ ~ {Life:40,LifeTime:60,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"large_ball",has_twinkle:true,has_trail:true,colors:[65527]}]}}}}
execute if score mode settings matches 0..4 if score firework settings matches 0 if score min time matches 0 if score sec time matches 30 if score sec2 time matches 0 as @a[team=nge] at @s run summon firework_rocket ~ ~ ~ {Life:40,LifeTime:60,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"large_ball",has_twinkle:true,has_trail:true,colors:[65527]}]}}}}
execute if score mode settings matches 0..4 if score firework settings matches 0 if score min time matches 0 if score sec time matches 30 if score sec2 time matches 0 as @a[team=nge] at @s run effect give @s glowing 30 0 true
##残り時間
